...
- (void)setupBackgroundLayerWithFillColor:(UIColor *)fillColor {
    ...
    self.backgroundLayer.strokeColor = [UIColor colorWithRed:229.0/255.0 green:229.0/255.0 blue:229.0/255.0 alpha:1.0].CGColor;
...
- (void)drawBackgroundCircle {
    ...
    [self.backgroundLayer removeAnimationForKey:@"drawCircleAnimation"];
}

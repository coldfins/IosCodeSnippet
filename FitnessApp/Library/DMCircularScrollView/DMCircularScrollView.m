...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        {
            scrollView.layer.borderColor = [UIColor colorWithRed:0.0/255.0 green:173.0/255.0 blue:221.0/255.0 alpha:1.0].CGColor;//[UIColor greenColor].CGColor;
            scrollView.layer.borderWidth = 2;
        }
        
        scrollView.backgroundColor = [UIColor colorWithRed:0.0/255.0 green:174.0/255.0 blue:164.0/255.0 alpha:1.0];
        self.backgroundColor = [UIColor colorWithRed:0.0/255.0 green:173.0/255.0 blue:221.0/255.0 alpha:1.0];
...
- (NSMutableArray *) viewsFromIndex:(NSUInteger) centralIndex preloadOffset:(NSUInteger) offsetLeftRight {
    NSMutableArray *viewsList = [[NSMutableArray alloc] initWithCapacity:(offsetLeftRight*2)+5];
...
- (void) relayoutPageItems:(NSUInteger) forceSetPage {
    ...
    NSUInteger pagesToCachePerSide = visiblePagesPerSide*3;

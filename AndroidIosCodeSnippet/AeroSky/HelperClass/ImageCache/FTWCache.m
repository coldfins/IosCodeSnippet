...
////    }
    ...
    for (NSString *file in [[NSFileManager defaultManager] contentsOfDirectoryAtPath:self.cacheDirectory error:&error]) {
        [[NSFileManager defaultManager] removeItemAtPath:[self.cacheDirectory stringByAppendingPathComponent:file] error:&error];
    }
}

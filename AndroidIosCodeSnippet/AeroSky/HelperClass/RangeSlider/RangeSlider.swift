...
class RangeSlider: UIControl {
    ...
    @IBInspectable var lowerValue: Int = 0 {
        didSet {
    ...
    @IBInspectable var upperValue: Int = 100{
        didSet {
    ...
    var gapBetweenThumbs: Int {
        return Int(thumbWidth)*(maximumValue - minimumValue) / Int(bounds.width)
    }
    ...
    func positionForValue(_ value: Int) -> Int {
        return Int(bounds.width - thumbWidth) * (value - minimumValue) / (maximumValue - minimumValue) + Int(thumbWidth / 2.0)
    }
